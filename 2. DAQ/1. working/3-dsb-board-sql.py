    ...
    try:
        ...
        if connection.is_connected():
            ...
            while True:
                ...
                insert_health_query = """
                    INSERT INTO board_health (cpu_temp, ram_usage, cpu_usage, disk_usage, net_up, net_down, core_volts, core_speed, arm_memory, gpu_memory, throttled_state, uptime)
